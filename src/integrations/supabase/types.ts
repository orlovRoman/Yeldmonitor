    ...
    Tables: {
      ...
      ratex_rates_history: {
        Row: {
          ...
          lower_yield: number | null
          upper_yield: number | null
          earn_w: number | null
          recorded_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "ratex_rates_history_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "ratex_pools"
            referencedColumns: ["id"]
          },
        ]
      }
      ratex_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "ratex_alerts_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "ratex_pools"
            referencedColumns: ["id"]
